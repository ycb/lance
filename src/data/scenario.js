...
export const commitments = {
  ...
  acComp: {
    ...
    summaryBrief: 'Guest relocated to Room 408. Comp request exceeds $100 frontline threshold — supervisor authorization required.',
    chainSteps: [
    ...
    thread: [
      ...
      { id: 'ac_t2', type: 'staff',  initials: 'MH', deptId: 'HK', name: 'Maria H.',  text: 'Cleaning up a spill on the 3rd floor. Be there in 10 min.',                       time: '9:24 AM' },
      { id: 'ac_t3', type: 'staff',  initials: 'JR', deptId: 'FD', name: 'James R.',  text: 'Guest is asking about comp. Should I tell him a supervisor will follow up?',       time: '9:31 AM' },
      { id: 'ac_t4', type: 'system',                                                   text: 'AI escalated to supervisor · 9:35 AM',                                             time: '9:35 AM' },
      { id: 'ac_t5', type: 'staff',  initials: 'MH', deptId: 'HK', name: 'Maria H.',  text: 'Room 408 is sparkling clean! ✨',                                                  time: '9:38 AM' },
      { id: 'ac_t6', type: 'you',    initials: 'SM', deptId: 'SUP', name: 'Sarah M.', text: 'James — any more details?',                                                        time: '9:41 AM' },
      { id: 'ac_t7', type: 'staff',  initials: 'JR', deptId: 'FD', name: 'James R.',  text: "Guest feels room is a downgrade. Doesn't like the view. Prefers 1 queen instead of 2 twins. Expressed frustration and disappointment.", time: '9:44 AM' },
    ],
    timeline: [
      {
        id: 'tl_0', type: 'guest',
        text: 'Reports problem with AC unit',
        time: '9:04 AM',
      },
      {
        id: 'tl_1', type: 'ai_action', subtype: 'dispatch',
        text: 'Dispatched Marcus T. (Maintenance) to inspect AC unit in Room 412',
        time: '9:05 AM',
      },
      {
        id: 'tl_2', type: 'staff_step',
        initials: 'MT', deptId: 'ME', name: 'Marcus T.', role: 'Maintenance',
        action: 'Inspect + repair AC unit',
        detail: 'Repair scheduled: 05/23/2026',
        status: S.COMPLETE,
        outcome: null,
        time: '9:21 AM',
      },
      {
        id: 'tl_3', type: 'ai_action', subtype: 'dispatch',
        text: 'Room move branch activated · dispatched Maria H. + James R. to relocate guest',
        time: '9:26 AM',
      },
      {
        id: 'tl_4', type: 'staff_step',
        initials: 'MH', deptId: 'HK', name: 'Maria H.', role: 'Housekeeping',
        action: 'Prep Room 408',
        status: S.COMPLETE,
        outcome: null,
        time: '9:34 AM',
      },
      {
        id: 'tl_5', type: 'staff_step',
        initials: 'JR', deptId: 'FD', name: 'James R.', role: 'Front Desk',
        action: 'Relocate Alex Chen to Room 408',
        status: S.COMPLETE,
        outcome: null,
        time: '9:34 AM',
      },
      {
        id: 'tl_6', type: 'ai_action', subtype: 'resolution_check',
        text: 'Resolution Check — Unresolved',
        detail: 'Comp request exceeds $100 frontline authority.',
        time: '9:35 AM',
      },
      {
        id: 'tl_7', type: 'ai_action', subtype: 'dispatch',
        text: 'Escalation request created · comp authorization required · dispatched to supervisor',
        time: '9:36 AM',
      },
      {
        id: 'tl_8', type: 'staff_step',
        initials: 'SM', deptId: 'SUP', name: 'Sarah M.', role: 'Supervisor',
        action: 'Authorize comp · Room 412',
        status: S.ACTIVE,
        outcome: null,
        time: '9:36 AM',
      },
